...
// Measured on a local graph-node holding the load graph scripts/scale-check.mjs
// builds — 84,163 versions, 332,985 resolved edges, 200 services. The 49ms/21ms/128
// figures these replaced were from the demo subtree, before the load test.
const STATS = [
  { value: "110ms", label: "Blast radius", sub: "140 services, 84K versions", highlight: true },
...
// Only what this actually talks to. The template listed Dependabot, Renovate,
// Snyk, Socket and three CI systems; none are integrated, and a logo wall of
// things you do not use is a lie told in a nice font.
const TECH_TAGS = [
