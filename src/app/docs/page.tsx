...
const QUICK_FACTS = [
  { value: "49ms", label: "Blast radius", sub: "compromise → exposed set" },
  { value: "21ms", label: "Path explain", sub: "algo.SPpaths" },
  { value: "128", label: "Resolved edges", sub: "express@4.19.2 subtree" },
